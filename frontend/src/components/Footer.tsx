export const Footer = () => {
    ...
    return (
        <>
            <div className="bg-[#dfecfd] flex justify-between gap-x-20">
                <div>
                    <div className="ml-30 p-4 mt-10 flex flex-col gap-y-4">
                        <p className="text-xl font-medium">SuperKalam</p>
                        <p>SuperKalam is your personal mentor to help UPSC students in their exam preparation</p>
